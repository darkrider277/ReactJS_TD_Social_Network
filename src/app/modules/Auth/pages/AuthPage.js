      ...
      <div className="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-row-fluid bg-white" id="kt_login">
          ...
          <div className="d-flex flex-row-fluid flex-column justify-content-between">
            ...
            <div className="flex-column-fluid d-flex flex-column justify-content-center">
              ...
              <p className="font-weight-lighter text-white opacity-80">
                <FormattedMessage id="AUTH.TITLE.SUB" />
              </p>
            </div>
            {/* end:: Aside content */}
            ...
            <div className="d-none flex-column-auto d-lg-flex justify-content-between mt-10">
              <div className="opacity-70 font-weight-bold	text-white">&copy; 2020 </div>
        ...
        <div className="flex-row-fluid d-flex flex-column position-relative p-7 overflow-hidden">
          ...
          <div className="d-flex d-lg-none flex-column-auto flex-column flex-sm-row justify-content-between align-items-center mt-5 p-5">
            <div className="text-dark-50 font-weight-bold order-2 order-sm-1 my-2">&copy; 2020 </div>
